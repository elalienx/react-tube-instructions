...
## Pre requisites
These are concepts that will be mentioned during this guide, that the student must read before starting the project.
1. [Download the project assets](https://www.dropbox.com/sh/i23r1xjoytin3a7/AABqDoUJUmPsnV3dwf-3N6csa?dl=0): Videos, thumbnails and logo.
2. [JavaScript](https://2020.school/main/books/25): Complete most of the previous labs.
3. [CSS Grid](https://css-tricks.com/snippets/css/complete-guide-grid/): Used to lay out the cards in columns.
4. [CSS Flexbox](https://css-tricks.com/snippets/css/a-guide-to-flexbox/): To position elements inside components.
...
4. Because JavaScript files can contain multiple functions, the export default command tells the compiler which function to use. For learning purposes, in this case we will write only one function per file.

## Import component
Let's go back to our `App.js` file on the top and import the newly created card:

![Figure](./images/readme/6.png)
